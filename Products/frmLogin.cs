...
namespace Products
{
    public partial class frmLogin : frmInheritance
    {
        ...
        private void btnLogin_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show("Access Denied", "Login Error", MessageBoxButtons.OK, MessageBoxIcon.Stop);
        ...
        private bool checkUserCanLogin()
        {
            ...
            string query = "select * from Users where UserName='"+ txtUserName.Text +"' and Password'"+ txtPassword +"'";
